...
<?php
   ...
   {
       $perintah="INSERT INTO customer (nama_cust,alamat,email,kota,telepon,via)
	              VALUES('$_GET[nama]','$_GET[alamat]',
				  '$_GET[email]','$_GET[kota]','$_GET[telepon]','$_GET[via]')";		
	   ...
	   {
           $perintah="INSERT INTO transaksi(id_transaksi,kode_kaset,jumlah,kode_cust)
